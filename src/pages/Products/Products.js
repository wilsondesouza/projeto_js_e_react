...
export default function Products({ addToCart }) {
  const [products] = useState([
    ...
    { id: 2, img: temperamentos, title: 'Temperamentos nos Estudos', price: 50.00, description: 'O livro Os quatro temperamentos nos estudos é uma obra obrigatória para estudantes, vestibulandos, concurseiros e universitários. Entender e conhecer seu temperamento irá guiar você por uma vida de estudos direcionada, menos ansiosa e mais proveitosa. Você será apresentado a dicas direcionadas para cada tipo de estudante, técnicas de estudo com validação científica e a experiência de um professor que ajuda milhares de alunos diariamente em suas redes sociais.' },
    ...
    { id: 5, img: programacao, title: 'POO com Python', price: 80.00, description: 'Aprenda de forma prática e descomplicada o paradigma da orientação a objetos por meio da linguagem de programação Python. Obra com abordagem autodidata prática, totalmente exemplificado e com explicações para cada linha de código.' },
            ...
            {products.map(product => (
              <Card key={product.id} style={{ width: '35vh' }} className="card product-card">
                <Card.Body className='carditems'>
                  ...
                  >
                    {addedToCart[product.id] ? <BsFillBagFill /> : <BsFillBagCheckFill />}
                  </Button>
                  <Button className='details' variant="secondary" onClick={() => openModal(product)}><FiMoreVertical/></Button>
                </Card.Body>
              </Card>
